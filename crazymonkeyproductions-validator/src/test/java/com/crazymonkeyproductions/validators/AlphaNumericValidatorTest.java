...
class AlphaNumericValidatorTest {
	...
	private AlphaNumericValidator testObj;

	@BeforeEach
	public void init() {
		testObj = new AlphaNumericValidator();
	}
	...
	void isValidAlphaNumericCharacters() {
		assertTrue(testObj.isValid("1", null));
	}

	@Test
	@DisplayName("Alpha Numeric characteres test")
	void isValidAlphaNumericCharactersAlphaNumeric() {
		assertTrue(testObj.isValid("123abc", null));
	}
